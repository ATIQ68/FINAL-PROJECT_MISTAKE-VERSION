...
;;-----------------------------------------------------------------
;;CONFIGURE TRIS
;PORTsend_data	clrf TRISA,A ;CONFIGURE OUTPUT PORTC
;				clrf TRISD,A ;CONFIGURE OUTPUT PORTD	
;				call setupLCD			 
;				return
;;
;;*******************CONFIGURE LCD********************************
;setupLCD	bcf PORTA,2,A ;RS=0
...
;SEND DATA
;
;setupLCD1	bsf PORTA,2,A	;RS=1	;DATA MODE
;			bcf PORTC,5,A	;RW=0
;			bsf PORTA,3,A	;E=1
;			call delay10msec
;			bcf PORTA,3,A	;EN=0
...
;			return
;
;bcd#		movlw 0xC0		;NUMBER # ;second line
;			movwf PORTD,A
;			;call setupLCD
;			movlw D'35'
;			movwf PORTD,A
...
;configure_keypad ;SETTING UP PORTB OF KEYPAD
;					SETF TRISB
;					return
;					
...
show_bcd2	setf PORTD,A
			bcf PORTD,4,A
			btfsc PORTB,2,A
			bra show_bcd1
			clrf PORTD,A
		
;show_bcd3	setf PORTD,A
;			bcf PORTD,4,A
;			btfsc PORTB,3,A
;			bra show_bcd4
;			clrf PORTD,A
;
;show_bcd4   setf PORTD,A
;		   	bcf PORTD,5,A
;			btfsc PORTB,1,A
;			bra bcd4
;			clrf PORTD,A
;
;show_bcd5   setf PORTD,A
;			bcf PORTD,5,A
;			btfsc PORTB,2,A
;			bra bcd5
;			clrf PORTD,A
;
;show_bcd6   setf PORTD,A
;			bcf PORTD,5,A
;			btfsc PORTB,3,A
;			bra bcd6
;			clrf PORTD,A
;
;show_bcd7	setf PORTD,A
;			bcf PORTD,6,A
;			btfsc PORTB,1,A
;			bra bcd7
;			clrf PORTD,A
;
;show_bcd8	setf PORTD,A
;			bcf PORTD,6,A
;			btfsc PORTB,2,A
;			bra bcd8
;			clrf PORTD,A
;		
;show_bcd9	setf PORTD,A
;			bcf PORTD,6,A
;			btfsc PORTB,3,A
;			bra bcd9
;			clrf PORTD,A
;
;show_star	setf PORTD,A
;			bcf PORTD,7,A
;			btfsc PORTB,1,A
;			bra bcd_star
;			clrf PORTD,A
